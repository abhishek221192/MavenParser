...
public final class MavenPomReader {
     ...
     */
    public static String createPathAndFilename(final String groupId, final String artifactId,
    ...
    private static void set(final Object dest, final String field, final Object value) {
        try {
            Utils4J.invoke(dest, toSetter(field), new Class[] { value.getClass() },
                    new Object[] { value });
        } catch (InvokeMethodFailedException ex) {
    ...
    private static void copyProperties(final Properties fromProps, final Object to,
            final String field) {
    ...
    private static String findLatestVersion(final File repositoryDir) {

        final File dir = new File(repositoryDir.getPath());
     ...
     */
    public static Model readModel(final File repositoryDir) {

        

        final File pomXmlFile = new File(repositoryDir.getPath());
        ...
        try {
            ...
            if (model.getParent() == null) {
                ...
                final Model parentModel = readModel(repositoryDir);
